# Простая соцсеть с комментариями и фотографиями Django
...
```
cd existing_repo
git remote add origin https://git.relabs.ru/newbies/task-tempates/django.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.relabs.ru/newbies/task-tempates/django/-/settings/integrations)
